                    ...
                    {summary ? (
                        <div style={styles.grid}>
                            <div style={styles.metricBox}>
                                ...
                                <strong style={styles.metricValue}>{summary.totalTickets}</strong>
                            </div>

                            <div style={styles.metricBox}>
                                <span style={styles.metricLabel}>Open</span>
                                <strong style={styles.metricValue}>{summary.openTickets}</strong>
                            </div>

                            <div style={styles.metricBox}>
                                <span style={styles.metricLabel}>In Progress</span>
                                <strong style={styles.metricValue}>{summary.inProgressTickets}</strong>
                            </div>

                            <div style={styles.metricBox}>
                                <span style={styles.metricLabel}>Resolved</span>
                                <strong style={styles.metricValue}>{summary.resolvedTickets}</strong>
                            </div>

                            <div style={styles.metricBox}>
                                <span style={styles.metricLabel}>Waiting Customer</span>
                                <strong style={styles.metricValue}>{summary.waitingCustomerTickets}</strong>
                            </div>

                            <div style={styles.metricBox}>
                                <span style={styles.metricLabel}>Unassigned</span>
                                <strong style={styles.metricValue}>{summary.unassignedTickets}</strong>
                            </div>

                            <div style={styles.metricBox}>
                                <span style={styles.metricLabel}>Critical Priority</span>
                                <strong style={styles.metricValue}>{summary.criticalPriorityTickets}</strong>
                            </div>
                        </div>
                    ) : null}
                </div>
